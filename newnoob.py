...
bot = telebot.TeleBot('7519734348:AAH6grCtysibCCb62AXxgIx9lydeB9wMHhQ') 

# -------------------------------
REQUIRED_CHANNELS = {
    "channel1": {
        "chat_id": "-1001846844159",  # अपना चैनल ID डालें
        "invite_link": "https://t.me/+OpuNLrMdms1jOTll"  # अपना इनवाइट लिंक
    },
    "channel2": {
        "chat_id": "-1001978245501",
        "invite_link": "https://t.me/NOOB_AM_CHEATS"
    }
}
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝐍𝐎𝐎𝐁 𝐀𝐌 𝐃𝐃𝐎𝐒 𝐖𝐎𝐑𝐋𝐃!", reply_markup=markup)
    
admin_id = {"708030615"}  # Existing admin IDs
users = {}
coins = {}
